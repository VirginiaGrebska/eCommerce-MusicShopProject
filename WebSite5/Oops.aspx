...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>MusicShop: Oops!</title>

    </head> 
    <body>
        <form id="form1" runat="server">
            <asp:HyperLink ID="HeaderLink" ImageUrl="~/Images/MusicShopLogo.png" NavigateUrl="~/" ToolTip="MusicShop logo" Text="MusicShop logo" runat="server" />    
            ...
            <p>The <b>MusicShop</b> team</p></form>
