...
public static class CatalogAccess
{
    ...
    public static ProductDetails GetProductDetails(string productId)
    {
        ...
        if (table.Rows.Count > 0)
        {
			...
			details.Album = dr["Album"].ToString();
			details.Artist = dr["Artist"].ToString();
    ...
    public static DataTable GetProductsOnFrontPromo(string pageNumber, out int howManyPages)
    {
        ...
        param.Value = MusicShopConfiguration.ProductDescriptionLength;
        param.DbType = DbType.Int32;
        comm.Parameters.Add(param);
        // create a new parameter
        ...
        param.Value = MusicShopConfiguration.ProductsPerPage;
        param.DbType = DbType.Int32;
        comm.Parameters.Add(param);
        // create a new parameter
        param = comm.CreateParameter();
      ...
      ["@HowManyProducts"].Value.ToString());
        howManyPages = (int)Math.Ceiling((double)howManyProducts / (double)MusicShopConfiguration.ProductsPerPage);
    ...
    (string departmentId, string pageNumber, out int howManyPages)
    {
        ...
        howManyPages = (int)Math.Ceiling((double)howManyProducts /
                       (double)MusicShopConfiguration.ProductsPerPage);
        // return the page of products
        return table;
    }
