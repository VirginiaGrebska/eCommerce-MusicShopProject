...
/// <summary>
/// Repository for MusicShop configuration settings
/// </summary>
public static class MusicShopConfiguration
{
...
// Returns the connection string for the MusicShop database
