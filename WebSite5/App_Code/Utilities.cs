...
public static class Utilities
{
    ...
    string body)
    {
        ...
        SmtpClient mailClient = new SmtpClient(MusicShopConfiguration.MailServer)
        {
            // Set credentials (for SMTP servers that require authentication)
            Credentials = new NetworkCredential(MusicShopConfiguration.MailUsername, MusicShopConfiguration.MailPassword)
        };
    ...
    public static void LogError(Exception ex)
    {
        ...
        if (MusicShopConfiguration.EnableErrorLogEmail)
        {
            string from = MusicShopConfiguration.MailFrom;
            string to = MusicShopConfiguration.ErrorLogEmail;
            string subject = "MusicShop Error Report";
